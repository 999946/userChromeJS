...
(function(){
  ...
  const FORCESORTSCRIPT = true; //強制的にスクリプトをファイル名順でソートするtrue, しない[false]
  ...
  var UCJS = new Array("UserCSSLoader","globalScript","UserScriptLoader"); //UCJS Loader 仕様を適用 (NoScriptでfile:///を許可しておく)
  var arrSubdir = new Array("", "UserCSSLoader", "xul","JS", "old","userMenu","UserScriptLoader");    //スクリプトはこの順番で実行される
//===================================================================
